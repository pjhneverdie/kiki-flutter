...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String codeName, T? value});
}
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  _$ApiResponseImpl({required this.codeName, this.value});
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(codeName: $codeName, value: $value)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, codeName, const DeepCollectionEquality().hash(value));
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  factory _ApiResponse({required final String codeName, final T? value}) =
      _$ApiResponseImpl<T>;
